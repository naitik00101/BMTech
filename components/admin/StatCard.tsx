...
export function StatCard({ label, value, icon: Icon, trend, className }: StatCardProps) {
  return (
    <div className={cn("p-8 rounded-2xl bg-surface border border-border flex items-start gap-6 relative overflow-hidden group transition-all duration-300 hover:border-accent-blue/40 hover:-translate-y-1 hover:shadow-2xl hover:shadow-accent-blue/10", className)}>
